...
/*плавные переходы по якорям*/
    $(".addMenue a").on("click", function (event) {
...
/*///////////////////////////////////////////
    Marketing
///////////////////////////////////////////*/
$('.dolar span').on('click', function () {
    toggleClass('dolarActive')
});
...
$(window).scroll(function () {
    if(innerWidth>1300){
        if ($(this).scrollTop() > snakeBlock1) {
            setTimeout("$('.snakeBlock1active').css('width', '1064')", 1000);
            setTimeout("$('.snakeBlock2active').css('height', '71')", 2770);
            setTimeout("$('.snakeBlock3active').css('height', '78')", 3700);
            setTimeout("$('.snakeBlock4active').css('width', '943')", 4100);
            setTimeout("$('.snakeBlock5active').css('height', '151')", 5900);
            setTimeout("$('.snakeBlock6active').css('height', '173')", 7300);
            setTimeout("$('.snakeBlock7active').css('width', '963')", 8150);
            setTimeout("$('.snakeBlock8active').css('height', '71')", 9550);   
        } 
    } 
});
snakeBlock2 = 1700;
    $(window).scroll(function () {
        if ($(this).scrollTop() > snakeBlock1) {
            if (innerWidth < 1300) {
                setTimeout("$('.snakeBlock1active').css('width', '500')", 1000);
                setTimeout("$('.snakeBlock2active').css('height', '71')", 1900);
                setTimeout("$('.snakeBlock3active').css('height', '78')", 2700);
                setTimeout("$('.snakeBlock4active').css('width', '370')", 3150);
                setTimeout("$('.snakeBlock5active').css('height', '151')", 4000);
                setTimeout("$('.snakeBlock6active').css('height', '173')", 5300);
                setTimeout("$('.snakeBlock7active').css('width', '400')", 6150);
            }
        }
    });
    
$('.assetsContentBlockHeder').on('click', function () {
    $(this).siblings().fadeToggle('slow');
});

$('.bankingPageContentBlockHeder').on('click', function () {
    $(this).siblings().fadeToggle('slow');
});
...
$('.addMenue .addMenueFaq li span').on('click', function () {
    if (addMenue == false){
        $('.addMenue').css('left', '0');
        $('.spanRight').toggleClass('spanLeft');
        addMenue = true;
    } else {
        $('.addMenue').css('left', '-247px');
        $('.spanRight').toggleClass('spanLeft');
        addMenue = false;
    }
});
...
$('.blogBloksRight').on('click', function () {
    if (innerWidth <= 768) {
        $(this).css('height', 'auto');
        $('.blogBloksRightClose').css('display', 'block');
        $('.blogBloksRightArrowDown').css('visibility', 'hidden');
        $('.blogBloksRightArrowDown').css('display', 'none');
    }
});

$('.blogBloksRightClose').on('click', function (ev) {
    ev.stopPropagation();
    $('.blogBloksRight').css('height', '137px');
    $(this).css('display', 'none');
    $('.blogBloksRightArrowDown').css('visibility', 'visible');
    $('.blogBloksRightArrowDown').css('display', 'block');
});

$('.blogBloksRightArrowDown').on('click', function (ev) {
    ev.stopPropagation();
    if (innerWidth <= 768) {
        $('.blogBloksRight').css('height', 'auto');
        $('.blogBloksRightClose').css('display', 'block');
        $('.blogBloksRightArrowDown').css('display', 'none!important');
        $('.blogBloksRightArrowDown').css('visibility', 'hidden!important');
    }
});
    /*///////////////////////////////////////////
        End trade_resurses
